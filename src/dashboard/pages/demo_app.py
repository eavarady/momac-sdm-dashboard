...
with st.sidebar:
    ...
    source = st.radio(
        "Select source", ["Simulated Data", "CSV", "Google Sheets", "Excel"], index=0
...
try:
    if source == "CSV":
        _tables = read_csv_tables()  # Real CSV data (no prefix, if needed)

    elif source == "Simulated Data":
        _tables = read_csv_tables(prefix="mock_")  # Simulated/mock data
