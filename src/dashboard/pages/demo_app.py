...
def show_welcome():
    ...
    st.write(
        """
        MOMAC SDM Dashboard helps you analyze manufacturing KPIs, visualize workflows, 
        detect bottlenecks, and forecast performance using advanced analytics and machine learning.
        
        **Capabilities include:**
        - KPI calculation and visualization
        - Workflow and Gantt charts
...
def show_login():
    ...
    st.write("This is the professional version. (No mock/demo data loaded.)")
    # Add login/authentication logic here if needed
...
def show_demo():
    ...
    def _build_forecast_line_safe(df, **kwargs):
        try:
            ...
            # Drop unknown kwargs (e.g., connect_actual) and retry
            safe_kwargs = {
                k: v for k, v in kwargs.items() if k not in {"connect_actual"}
            }
            return build_forecast_line(df, **safe_kwargs)
